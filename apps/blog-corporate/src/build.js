...
.hero h2 { margin: 0; font-size: 2rem; color: var(--navy-dark); }
...
async function generateHomepage(posts) {
  ...
  <h2>회사 소개</h2>
  <p>우리는 신뢰할 수 있는 디지털 서비스를 제공하는 파트너입니다. 최신 소식과 인사이트를 확인하세요.</p>
  <div class="actions">
    <a class="btn" href="/posts/page/1/">최신 소식 보기</a>
    <a class="btn secondary" href="/posts/page/1/">회사 뉴스룸</a>
  </div>
</section>
<section>
...
async function generateCategoryPages(posts, categories) {
  ...
  <p>${escapeHtml(post.excerpt || "")}</p>
      ...
      const html = layoutHtml({
        ...
        content: `<h2 class="section-title">${escapeHtml(
