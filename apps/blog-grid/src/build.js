...
const FALLBACK_IMAGE = `data:image/svg+xml;utf8,${encodeURIComponent(
  `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="520">
    ...
    <rect x="40" y="40" width="720" height="440" fill="none" stroke="#ffffff" stroke-width="3" opacity="0.6"/>
  </svg>`
)}`;
...
@media (max-width: 720px) {
  ...
  .post-media { flex-basis: auto; aspect-ratio: 4 / 3; }
}
</style>`;
...
async function generatePostListPages(posts) {
  ...
  <div class="post-media">
    <img src="${escapeHtml(resolvePostImage(post))}" alt="${escapeHtml(
  ...
  <div class="post-body">
    ...
    const html = layoutHtml({
      ...
      content: `<ol class="post-grid" start="${(page.page - 1) * PAGE_SIZE + 1}">
${entries}
</ol>
